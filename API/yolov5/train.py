...
def train_parse_opt(known=False, weights='yolov5s.pt', data='yolov5/data/coco128.yaml', epochs=300, batch_size=16):
    ...
    parser.add_argument('--project', default='yolov5/runs/train', help='save to project/name')
